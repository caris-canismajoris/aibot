import 'package:aibot/screens/app_screens/allow_notification_screen/allow_notification_screen.dart';
import '../config.dart';
...
class AppRoute {
  final List<GetPage> getPages = [
    ...
    GetPage(
        name: _routeName.musicForPostScreen,
        page: () => const MusicForPostScreen()),
    GetPage(
    ...
    GetPage(
        name: _routeName.getWellMessageScreen,
        page: () => GetWellMessageScreen()),
    GetPage(
        name: _routeName.newBabyWishesScreen,
        page: () => NewBabyWishesScreen()),
    GetPage(name: _routeName.translateScreen, page: () => TranslateScreen()),
    ...
    GetPage(
        name: _routeName.newYearGreetingScreen,
        page: () => NewYearGreetingScreen()),
    GetPage(
        name: _routeName.mothersDayWishesScreen,
        page: () => MothersDayWishesScreen()),
    GetPage(
        name: _routeName.fathersDayWishesScreen,
        page: () => FathersDayWishesScreen()),
    GetPage(
        name: _routeName.promotionWishesScreen,
        page: () => PromotionWishesScreen()),
    GetPage(name: _routeName.babyShowerScreen, page: () => BabyShowerScreen()),
    GetPage(
        name: _routeName.farewellMessageScreen,
        page: () => FarewellMessageScreen()),
    GetPage(
        name: _routeName.weddingWishesScreen,
        page: () => WeddingWishesScreen()),
    GetPage(
        name: _routeName.manageApiKeyScreen, page: () => ManageApiKeyScreen()),
    GetPage(name: _routeName.addApiKeyScreen, page: () => AddApiKeyScreen()),
    GetPage(
        name: _routeName.contentWriterScreen,
        page: () => ContentWriterScreen()),
    GetPage(name: _routeName.settingScreen, page: () => Setting()),
    GetPage(
        name: _routeName.allowNotificationScreen,
        page: () => AllowNotificationScreen()),
    GetPage(
        name: _routeName.ecommerceDetailsScreen, page: () => EcommerceScreen()),

        //new features
        GetPage(name: _routeName.chatGeminiScreen, page: () => SplashScreen()),
  ];
}
