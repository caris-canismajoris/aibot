...
import '../../../../config.dart';
import 'temp_pass_gen_controller.dart';

class TempPasswordGeneratorScreen extends StatelessWidget {
  // final passwordCtrl = Get.put(PasswordControllerTemp());

  const TempPasswordGeneratorScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Get.put(PasswordControllerTemp());
    return GetBuilder<PasswordControllerTemp>(builder: (passwordCtrl) {
      return WillPopScope(
          ...
          child: DirectionalityRtl(
              child: Scaffold(
                  ...
                  body: Stack(children: [
                    ...
                    if (passwordCtrl.isLoader == true) const CircularProgressIndicator(),
                    // LoaderLayout()
                  ],),),),);
    });
  }
