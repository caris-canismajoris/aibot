...
class EssayGenerateLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<EssayWriterControllerTemp>(
      builder: (essayWriterCtrl) {
        return Stack(
          children: [
            Container(
                ...
                Column(
                  ...
                  children: [
                    textCommon.outfitSemiBoldPrimary16(
                        text: appFonts.getAnExceptional),
                      ...
                      child: Column(
                        ...
                        children: [
                          InputLayout(
                            ...
                            onTap: () =>
                                essayWriterCtrl.essayController.clear(),
                          ),
                          const VSpace(Sizes.s20),
                          textCommon.outfitSemiBoldTxt14(
                              text: appFonts.essayType),
                          ...
                          Row(
                            ...
                            children: essayWriterCtrl.essayTypeLists
                                ...
                                .entries
                                .map(
                                  (e) => PasswordRadioButtonLayout(
                                    data: e.value,
                                    index: e.key,
                                    selectIndex: essayWriterCtrl.selectedIndex,
                                    onTap: () =>
                                        essayWriterCtrl.onEssayTypeChange(
                                      e.key,
                                    ),
                                  ),
                                )
