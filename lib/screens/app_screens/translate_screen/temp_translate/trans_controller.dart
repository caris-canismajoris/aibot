...
class TempTranslateController extends GetxController
  ...
  final GeminiTranslateApi geminiTranslateApiInstance = GeminiTranslateApi();
...
//new_features
        ...
        TempTranslateController translateGeneratorCtrl = Get.find<TempTranslateController>();
        ...
        processedResultsAISubscription.onData((outputValue) {
          ...
          print("translateGeneratorCtrl ==> ${markdownText}");
            ...
            if (resultMessageAi != "") {
              response = resultMessageAi;
              print("responsetranslateGeneratorCtrl ==> ${response}");
              update();
              isTranslated = true;
              isLoader = false;
              update();
