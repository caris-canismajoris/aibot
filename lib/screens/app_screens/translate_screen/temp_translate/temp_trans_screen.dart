import '../../../../config.dart';
import 'temp_without_tr.dart';
import 'trans_controller.dart';

class TempTranslateScreen extends StatelessWidget {
  final translateCtrl = Get.put(TempTranslateController());

  TempTranslateScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<TempTranslateController>(builder: (_) {
      return WillPopScope(
              ...
              children: [
                ListView(
                  children: [
                    ...
                    // // translate layout
                    const TempWithoutTranslateLayout(),
                ...
                if (translateCtrl.isLoader == true)
