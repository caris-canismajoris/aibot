                    ...
                    : Scaffold(
                        ...
                        bottomNavigationBar: Container(
                          ...
                          child: ConvexAppBar(
                            ...
                            onTap: (int index) =>
                                dashboardCtrl.onBottomTap(index),
                          ),
                          // .bottomNavExtension(),
                          ...
                          //           index: 1),
                          //     if (appCtrl
                          //         .firebaseConfigModel!.isImageGeneratorShow!)
                          //       TabCommon(
                          //           title: "image",
                          //           sImage: eSvgAssets.galleryColor,
                          //           usImage: eSvgAssets.gallery,
                          //           index: 2),
                          //     if (appCtrl.firebaseConfigModel!.isVoiceEnable!)
                          //       TabCommon(
                          //           title: "voice",
                          //           sImage: eSvgAssets.micColor,
                          //           usImage: eSvgAssets.micNav,
                          //           index: 3),
                          //     if (appCtrl.firebaseConfigModel!.isCameraEnable!)
                          //       TabCommon(
                          //           title: "camera",
