import 'package:aibot/common/assets/index.dart';
...
class FirebaseConfigModel {
  ...
  bool? isTheme, isRTL;
  bool? isAddShow, isChatHistory, isGuestLoginEnable, isGoogleAdmobEnable;
  //new features
  bool? isGeminiShow;
  ...
  FirebaseConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    isGeminiShow = json['isGeminiShow'] ?? true;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    //new features 
    data['isGeminiShow'] = isGeminiShow;
