...
import 'package:aibot/widgets/balance_alert.dart';
...
class AppController extends GetxController {
  ...
  void loadRewardedVideoAd() {
    FacebookRewardedVideoAd.loadRewardedVideoAd(
      placementId: Platform.isAndroid
          ? appCtrl.firebaseConfigModel!.facebookRewardAd!
          : appCtrl.firebaseConfigModel!.facebookRewardIOSAd!,
  ...
  showFacebookRewardedAd() async {
    if (isRewardedAdLoaded == true) {
      ...
      int count =
          envConfig["balance"] + appCtrl.firebaseConfigModel!.rewardPoint;
      envConfig["balance"] = count;
      update();
      if (!appCtrl.isGuestLogin) {
        final subscribeCtrl = Get.isRegistered<SubscriptionFirebaseController>()
