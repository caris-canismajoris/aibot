...
import 'package:aibot/bot_api/api_services.dart';
    ...
    if (scaffoldKey.currentState!.validate()) {
      ...
      if (balance == 0) {
        ...
        ApiServices.chatCompeletionResponse(
                "suggest new born baby ${genderLists[selectIndex]['title']} ${babyController.text} message from ${relationGenController.text} in $langOnSelect")
            .then((value) {
          if (value != "") {
            response = value;
            update();
